...
such as a programming competition. Recent resarch has shown that some of the
...
of the training dataset, specifically different levels of optimisation (-O0 to
-O3) and static linkage. We find that full optimisation yields a 10\% drop
in accuracy in datasets with 191 and 20 authors respectively. Static linkage
results in a 46\% and 36\% drop in accuracy in datasets with 20 and 10 authors,
